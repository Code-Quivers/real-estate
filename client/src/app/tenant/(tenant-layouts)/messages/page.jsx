...
import TenantChatPerson from "@/components/tenant/messaging/TenantChatPerson";
import TenantChats from "@/components/tenant/messaging/TenantChats";
          ...
          <div className="col-span-2 border border-black overflow-y-scroll  ">
            {conversations.map((singleConversation, index) => (
              <div
                ...
                `}
              >
                <TenantChatPerson personName={singleConversation?.user?.name} chatId={singleConversation?.id} />
              </div>
            ))}
          </div>
