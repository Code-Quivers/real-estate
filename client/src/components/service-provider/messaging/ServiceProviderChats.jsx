...
import ServiceProviderChatBubbleIncoming from "./ServiceProviderChatBubbleIncoming";
import ServiceProviderChatBubbleOutgoing from "./ServiceProviderChatBubbleOutgoing";
          ...
          {chatObj?.messages?.map((message) => (
            <div key={Math.random()} className={`flex w-full ${message?.incoming === true ? "justify-start" : "justify-end"}`}>
              {message?.incoming === true ? (
                ...
                <ServiceProviderChatBubbleOutgoing message={message} />
              )}
            </div>
          ))}
        </div>
...
export default ServiceProviderChats;
