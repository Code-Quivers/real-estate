...
const UploadTenantDocument = ({ field }) => {
  ...
  return (
    <div>
      {field?.value ? (
        ...
        <Uploader action="" fileListVisible={false} draggable autoUpload={false} onChange={handleChangeImages} accept=".pdf">
...
export default UploadTenantDocument;
